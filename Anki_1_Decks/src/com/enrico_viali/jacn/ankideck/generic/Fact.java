...
public class Fact {
	...
	public Fact(long factId, IAnkiDeckGeneric deckMgrPar) {
		super();
	...
	public boolean mergeWithOther(Fact other) {
	...
	public String getKeyFieldName() throws AnkiDeckMalformedFact {
		return getFieldStrValue(deckMgr.getKeyFieldName(), true);
	}

	public String getKeyFieldValue() throws AnkiDeckMalformedFact {
		String name = deckMgr.getKeyFieldName();
	...
	private static org.apache.log4j.Logger log = Logger.getLogger(Fact.class);
}
