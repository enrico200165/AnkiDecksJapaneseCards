...
public class Anki2DeckGeneric implements IAnkiDeckGeneric {

	public Anki2DeckGeneric(String dName, IAnkiDeckDataModel dmPar, String expr, boolean allowDuplicate) {
	...
	@Override
	public boolean load() {
		return load(this.getDeckName(), this.getKeyFieldName());
	}
	...
	public boolean load(String deckPathName, String keyExpression) {
	    return dm.readFactsDeck(this, getKeyFieldName());
	}
	...
	private static org.apache.log4j.Logger log = Logger.getLogger(Anki2DeckGeneric.class);
}
